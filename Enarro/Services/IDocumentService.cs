...
{
    Task<DocumentIngestResult> IngestAsync(IFormFile file, Dictionary<string, string>? tags = null, CancellationToken cancellationToken = default);
    Task<BatchIngestResult> IngestBatchAsync(IEnumerable<IFormFile> files, CancellationToken cancellationToken = default);
